...
class Core
{
    public:
        ...
        void setCoreId(const unsigned id);
		void reset_proc();
		//bool getInitCore();
		//void setInitCore();
		//void writePC(const unsigned pc);
		//void setOutFileAndMem(/*std::ofstream &outFile,*/ Memory &Mem);
		//void setDestructionPC(const unsigned pc);
		unsigned getDestructionPC();
		//unsigned getPC();
